...
#define ALTERNATE_FUNCTION_PP 		0x20
#define ANALOG 					0x03


/* Peripheral IDs for AF pins */
#define UART1		7
#define UART2		7
#define UART6 		8
...
void GPIO_MapAFPin(unsigned char portID, unsigned char pin_number, unsigned char peripheral_id);
